          ...
          <View style={styles.dropDownContainer}>
            ...
            >
              <View style={styles.overlay}>
                ...
                >
                  <Text style={styles.overlayText}>Museum</Text>
                </TouchableOpacity>
                ...
                >
                  <Text style={styles.overlayText}>Concert</Text>
                </TouchableOpacity>
                ...
                >
                  <Text style={styles.overlayText}>Application Error</Text>
                </TouchableOpacity>
                ...
                >
                  <Text style={styles.overlayText}>Rafi Peer Service</Text>
                </TouchableOpacity>
              </View>
            </Overlay>
          </View>
